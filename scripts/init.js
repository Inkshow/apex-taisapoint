...
window.onload = function () {
  ...
  //获取选择中的地图
  let selectedmap =
    document.getElementsByClassName("mapselectbtn")[0].dataset.selectedmap;
  ...
  request.onload = function () {
    ...
    function analyze(a) {
      ...
      let htmlcontent = "";
      //遍历
      for (var i = 0; i < json.taisapoints.length; i++) {
      ...
      htmlcontent = "";
      //遍历
      for (var i = 0; i < json.chargeriflepoints.length; i++) {
